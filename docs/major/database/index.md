...
=== "柳晴"
    ...
    老师人挺好，24 级小测错过了也可以补。讲课内容比较详细但是基本读 PPT，相当催眠。
...
=== "柳晴"
    ...
    * 平时作业 (10%)
        ...
        每讲完一章布置一次教材上的课后习题。此外 25-26 春夏还有 4 次 bonus。

    * Quiz (10%)
        
        25-26 春夏号称 3-4 次纸质开卷小测，实际只有两次。第一次提前一周通知，第二次未提前通知，但两次都可以在最后一次验收的时候补。
        
        此外，前半学期还会有几次当堂线上抢答形式的小测验，得分前三的可以获得平时分加分，但不做应该也没有什么影响。

    * Lab (30%)

        要求和其他班类似；图书管理系统和 MiniSQL 需要验收。MiniSQL 可以用算法设计替代，但似乎没什么人做这个。
